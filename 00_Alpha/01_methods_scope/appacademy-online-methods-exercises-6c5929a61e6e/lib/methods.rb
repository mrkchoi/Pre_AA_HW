...
def dec_remainder_of_two_floats(f_dividend, f_divisor)
    (f_dividend.to_f / f_divisor.to_f) - (f_dividend.to_i / f_divisor.to_i)
end
...
def int_remainder_without_modulo(i_dividend, i_divisor)
    float_output = (dec_remainder_of_two_integers(i_dividend, i_divisor) * i_divisor)
    output = float_output.round
end

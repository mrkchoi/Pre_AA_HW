...
Toy.create(name: 'Yarn', cat_id: Cat.first.id)
Toy.create(name: 'Sqeaker', cat_id: Cat.first.id)
Toy.create(name: 'Feather', cat_id: Cat.last.id)
Toy.create(name: 'Ball', cat_id: Cat.last.id)

...
def neighbors_of_certain_b_countries
  ...
  execute(<<-SQL)
    SELECT
      name, continent AS continent_output
    FROM 
      countries
    WHERE
      continent = (
...
# find total num of countries in a continent
# find count of countries for a continent that have matching pop
